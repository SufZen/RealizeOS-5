...
import { Settings, Shield, Cpu, Server, RefreshCw, Database, AlertCircle, Check, Route, FileText, Loader2, Search } from 'lucide-react'
import { useApi } from '@/hooks/use-api'
import { api } from '@/lib/api'
import { cn } from '@/lib/utils'
import { Toggle, StatusBanner } from './settings/shared'
...
/* ------------------------------------------------------------------ */
/* Remaining inline sections (small enough to keep here)              */
/* ------------------------------------------------------------------ */
