...
def _gmail_forward_sync(message_id: str, to: str, note: str = "") -> dict:
    ...
    if payload.get("body", {}).get("data"):
        orig_body = base64.urlsafe_b64decode(payload["body"]["data"]).decode("utf-8", errors="replace")
    elif payload.get("parts"):
        for part in payload["parts"]:
            if part.get("mimeType") == "text/plain" and part.get("body", {}).get("data"):
                orig_body = base64.urlsafe_b64decode(part["body"]["data"]).decode("utf-8", errors="replace")
                break
...
GOOGLE_TOOL_SCHEMAS = [
    ...
    {
        "name": "gmail_search",
        "description": "Search emails in Gmail by sender, subject, keywords, or date.",
        "input_schema": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Gmail search query (e.g., 'from:name subject:budget', 'is:unread')",
                },
    ...
    {
        "name": "gmail_send",
        "description": "Send an email. Write operation — requires confirmation.",
        "input_schema": {
            "type": "object",
            "properties": {
                "to": {"type": "string"},
    ...
    },
    {
        ...
        "description": "Create a draft email. Write operation — requires confirmation.",
        "input_schema": {
            "type": "object",
            "properties": {
                "to": {"type": "string"},
    ...
    {
        "name": "gmail_reply",
        "description": "Reply to an existing email thread. Write operation.",
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "gmail_forward",
        "description": "Forward an email to another address. Write operation.",
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "gmail_triage",
        "description": "Bulk triage emails: add/remove labels, mark read, archive. Write operation.",
        "input_schema": {
            "type": "object",
            "properties": {
                "message_ids": {
    ...
    },
    {
        ...
        "description": "Add a label to messages (creates label if needed). Write operation.",
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Create a calendar event. Write operation.",
        "input_schema": {
            "type": "object",
            "properties": {
                "summary": {"type": "string"},
    ...
    },
    {
        ...
        "description": "Update an existing calendar event. Write operation.",
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Find busy/free time slots across calendars.",
        "input_schema": {
            "type": "object",
            "properties": {
                "time_min": {"type": "string"},
    ...
    },
    {
        ...
        "description": "Read text content of a Google Doc/Sheet/file.",
        "input_schema": {"type": "object", "properties": {"file_id": {"type": "string"}}, "required": ["file_id"]},
    },
    {
        "name": "drive_create_doc",
        "description": "Create a new Google Doc. Write operation.",
        "input_schema": {
            "type": "object",
            "properties": {"title": {"type": "string"}, "content": {"type": "string"}, "folder_id": {"type": "string"}},
            "required": ["title"],
        },
    },
    {
        "name": "drive_append_doc",
        "description": "Append text to an existing Google Doc. Write operation.",
        "input_schema": {
            "type": "object",
    ...
    {
        "name": "drive_upload",
        "description": "Upload a local file to Google Drive. Write operation.",
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "drive_set_permissions",
        "description": "Share a Drive file with an email address. Write operation.",
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "drive_move",
        "description": "Move a file to a different Drive folder. Write operation.",
        "input_schema": {
            "type": "object",
            "properties": {
